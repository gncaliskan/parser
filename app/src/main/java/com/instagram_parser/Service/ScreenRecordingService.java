...
public class ScreenRecordingService {
    ...
    private static void createVideoShareIntent(String mediaPath) {
        ...
        MainActivity.getMainContext().startActivity(Intent.createChooser(share, "Share to"));
    }
    ...
    public static void prepareRecording() {
        ...
        if (!Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
            Toast.makeText(context, R.string.bellegeUlasilamadi, Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if (success) {
            ...
            Toast.makeText(context, R.string.klasorOlusturulamadi, Toast.LENGTH_SHORT).show();
            return;
        }
